...
<body bgcolor="#ffffff" style="margin: 0; padding: 0; box-sizing: border-box; ">
   ...
   <div class="button" align="center" style="background-color:lightcoral;padding:15px;">
      <button type="button" name="homepagebutton" onclick="location.href='homepage.html'">Home Page</button>
   </div>
   </link>
   <div align="center" <div class="btn-div" style="background-color: rgb(236, 161, 161);padding:20px; min-height: 76vh;">
   ...
   <div align="center" style="background-color:lightcoral;padding:15px; min-height: 10vh;">
      <?php
